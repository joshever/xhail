...
_lr_productions = [
  ...
  ('schema_terms -> term','schema_terms',1,'p_schema_terms','parser.py',123),
  ('schema_terms -> term COMMA schema_terms','schema_terms',3,'p_schema_terms','parser.py',124),
  ('min_max_bias -> MAX NUMBER MIN NUMBER','min_max_bias',4,'p_min_max_bias','parser.py',147),
  ('min_max_bias -> MAX NUMBER','min_max_bias',2,'p_min_max_bias','parser.py',148),
  ('priority_bias -> PRIORITY NUMBER','priority_bias',2,'p_priority_bias','parser.py',157),
  ('weight_bias -> WEIGHT NUMBER','weight_bias',2,'p_weight_bias','parser.py',162),
  ('bias -> min_max_bias weight_bias priority_bias','bias',3,'p_bias','parser.py',167),
  ('bias -> min_max_bias priority_bias','bias',2,'p_bias','parser.py',168),
  ('bias -> min_max_bias weight_bias','bias',2,'p_bias','parser.py',169),
  ('bias -> weight_bias priority_bias','bias',2,'p_bias','parser.py',170),
  ('bias -> weight_bias','bias',1,'p_bias','parser.py',171),
  ('bias -> priority_bias','bias',1,'p_bias','parser.py',172),
  ('bias -> min_max_bias','bias',1,'p_bias','parser.py',173),
  ('example -> EXAMPLE_KEY atom DOT','example',3,'p_example','parser.py',190),
  ('example -> EXAMPLE_KEY NOT atom DOT','example',4,'p_example','parser.py',191),
  ('example -> EXAMPLE_KEY atom bias DOT','example',4,'p_example','parser.py',192),
  ('example -> EXAMPLE_KEY NOT atom bias DOT','example',5,'p_example','parser.py',193),
  ('example -> EXAMPLE_KEY zero_predicate DOT','example',3,'p_example','parser.py',194),
  ('example -> EXAMPLE_KEY NOT zero_predicate DOT','example',4,'p_example','parser.py',195),
  ('example -> EXAMPLE_KEY zero_predicate bias DOT','example',4,'p_example','parser.py',196),
  ('example -> EXAMPLE_KEY NOT zero_predicate bias DOT','example',5,'p_example','parser.py',197),
  ('modeh -> MODEH_KEY schema DOT','modeh',3,'p_modeh','parser.py',221),
  ('modeh -> MODEH_KEY schema bias DOT','modeh',4,'p_modeh','parser.py',222),
  ('modeh -> MODEH_KEY zero_predicate DOT','modeh',3,'p_modeh','parser.py',223),
  ('modeh -> MODEH_KEY zero_predicate bias DOT','modeh',4,'p_modeh','parser.py',224),
  ('modeb -> MODEB_KEY schema DOT','modeb',3,'p_modeb','parser.py',245),
  ('modeb -> MODEB_KEY NOT schema DOT','modeb',4,'p_modeb','parser.py',246),
  ('modeb -> MODEB_KEY schema bias DOT','modeb',4,'p_modeb','parser.py',247),
  ('modeb -> MODEB_KEY NOT schema bias DOT','modeb',5,'p_modeb','parser.py',248),
  ('modeb -> MODEB_KEY zero_predicate DOT','modeb',3,'p_modeb','parser.py',249),
  ('modeb -> MODEB_KEY NOT zero_predicate DOT','modeb',4,'p_modeb','parser.py',250),
  ('modeb -> MODEB_KEY zero_predicate bias DOT','modeb',4,'p_modeb','parser.py',251),
  ('modeb -> MODEB_KEY NOT zero_predicate bias DOT','modeb',5,'p_modeb','parser.py',252),
  ('terms -> term','terms',1,'p_terms','parser.py',279),
  ('terms -> atom','terms',1,'p_terms','parser.py',280),
  ('terms -> term COMMA terms','terms',3,'p_terms','parser.py',281),
  ('terms -> atom COMMA terms','terms',3,'p_terms','parser.py',282),
  ('fact -> atom DOT','fact',2,'p_fact','parser.py',295),
  ('fact -> zero_predicate DOT','fact',2,'p_fact','parser.py',296),
  ('constraint -> IMPLIES body DOT','constraint',3,'p_constraint','parser.py',302),
  ('normal_clause -> atom IMPLIES body DOT','normal_clause',4,'p_normal_clause','parser.py',308),
  ('normal_clause -> zero_predicate IMPLIES body DOT','normal_clause',4,'p_normal_clause','parser.py',309),
  ('body -> literal COMMA body','body',3,'p_body','parser.py',315),
  ('body -> literal','body',1,'p_body','parser.py',316),
  ('literal -> NOT atom','literal',2,'p_literal','parser.py',325),
  ('literal -> atom','literal',1,'p_literal','parser.py',326),
  ('literal -> term OPERATOR term','literal',3,'p_literal','parser.py',327),
  ('literal -> NOT term OPERATOR term','literal',4,'p_literal','parser.py',328),
  ('literal -> NOT zero_predicate','literal',2,'p_literal','parser.py',329),
  ('literal -> zero_predicate','literal',1,'p_literal','parser.py',330),
]
